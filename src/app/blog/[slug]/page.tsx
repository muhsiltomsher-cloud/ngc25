    ...
    return (
      <main className="min-h-screen bg-white">
        <Container className="py-16">
          <p className="text-center text-slate-600">Post not found.</p>
          <p className="text-center mt-4"><Link href="/blog" className="text-blue-600">Back to Blog</Link></p>
        </Container>
      </main>
    );
  }
  ...
  return (
    <main className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-slate-50">
      <Container className="py-10">
        <nav aria-label="Breadcrumb" className="mb-4 text-sm text-slate-600"><Link href="/">Home</Link><span className="mx-2">/</span><Link href="/blog">Blog</Link><span className="mx-2">/</span><span className="text-slate-900">{article.title}</span></nav>
        ...
        <article className="mx-auto max-w-3xl">
          ...
          <div className="mt-10"><Link href="/blog" className="text-sm font-semibold text-blue-600">← Back to Blog</Link></div>
        </article>
      </Container>
    </main>
  );
