...
interface WhyChooseFlooringsSectionProps {
  headline: string;
  features: Feature[];
  className?: string;
}
...
const WhyChooseFlooringsSection: React.FC<WhyChooseFlooringsSectionProps> = ({
  headline,
  features,
  className = '',
}) => {
...
export default WhyChooseFlooringsSection;